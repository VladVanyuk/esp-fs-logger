...
#define LOG_LEVEL           3         // (0 disable, 1 error, 2 info, 3 debug)
    ...
    #define ESP_FS_WS_SETUP             1   //has setup methods
        ...
        #define ESP_FS_WS_SETUP_HTM     0   //included from progmem 
    #endif
#endif

#ifndef ESP_FS_WS_LOGS
    #define ESP_FS_WS_LOGS             1   //has general log file
    #ifndef ESP_FS_WS_LOGS_CSV
        #define ESP_FS_WS_LOGS_CSV     1   //create csv logs dir
    #endif
#endif
    ...
    #include "SetupConfig.hpp"
      ...
      #include "setup_htm.h"
    #endif
    #include "CaptivePortal.hpp" //todo check
#endif


#if ESP_FS_WS_LOGS
    #define ESP_FS_WS_LOGS_FOLDER "/logs"
    #define ESP_FS_WS_LOGS_FILE  "/logs/logsMain.txt"
    #if ESP_FS_WS_LOGS_CSV
      #define ESP_FS_WS_LOGS_CSV_FOLDER  "/logs/csv"
      #define ESP_FS_WS_LOGS_CSV_FILE  "/logs/csv/logs.csv"
    #endif
#endif
...
class AsyncFsWebServer : public AsyncWebServer
{
  ...
  */
  ...
  private:
    ...
    String m_host = "esp";
    String m_captiveUrl = "/edit.htm"; //was setup
